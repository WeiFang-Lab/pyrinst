...
def main():
    ...
    with open(args.input, 'rb') as f: input = pickle.load(f)
    ...
    print(f"delta F({int(250)}K)=: {df0.real * Energy(1, 'Hartree').get('eV') + df1 * Energy(1, 'Hartree').get('eV'):.10e} eV")
