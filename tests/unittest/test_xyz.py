...
def test_save_and_load_roundtrip(tmp_path):
    ...
    symbols_loaded, coords_loaded, comments_loaded = xyz.load(test_filepath)
...
def test_load_single_frame_squeezes_dimension(tmp_path):
    ...
    _, coords_loaded, _ = xyz.load(test_filepath, energy_pattern=False)
...
def test_load_raises_oserror_on_malformed_file(tmp_path):
    """Tests that `load` raises an OSError for a malformed file.
